//check if 2 strings are anagrams-"silent"-"listen", if they are return "True",else "False"
...
class Solution {
    public List<Integer> findAnagrams(String s, String p) {
        ...
        //Create frequency arrays to store the frequency of each character in window and p_freq 
        ...
        //Arrays.equals function check that two array are equivalent or not
         //if two array are qual means we found are anagram add it to arraylist
